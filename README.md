...
1.  **[OmegaUp](https://github.com/omegaup/omegaup)**:  Have 40+ merged PRs.
    * **Key Contributions:**
...
1.  **[GSoC Espionage](https://github.com/Ankitsinghsisodya/Gsoc-espionage)**: GitHub PR analytics app with 1.4k active users which show merge rates, contributor stats, and activity timelines about any repo. Features branch filtering, data exports, GSoC 2026 organizations lists, and theme support.
